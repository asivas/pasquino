...
class excelReportWriter extends reportWriter
{
    ...
    /**
     * Cambia la ruta donde se generar� el archivo xls
    ...
    /**
     * Recupera la ruta en que se generar� el archivo xls
     * @return string la ruta donde ser� generado el xls por esta clase
     */
