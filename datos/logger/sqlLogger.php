...
/**
 * Se define la clase sqlLogger que permite hacer entradas de registro para una aplicaci�n
...
class sqlLogger extends logger {
     ...
     * @param string $mode puede ser 'db' o 'file' determina que tipo de log se utilizar�
